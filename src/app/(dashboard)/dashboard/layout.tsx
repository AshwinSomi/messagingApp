...
const Layout = async ({ children }: LayoutProps) => {
  ...
  // console.log("unseenRequestsCount", unseenRequestsCount);

  return (
    <div className="w-full flex h-screen">
      <div className="flex h-full w-ful max-w-xs grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6 ">
            ...
            <li className="-mx-6 mt-auto flex items-center ">
              <div className="flex flex-1 items-center gap-x-4 px-6 py-3 text-sm font-semibold leading-6 text-gray-900 ">
                ...
                <div className="flex flex-col ">
                  ...
                  <span className="text-xs tex-zinc-400 " aria-hidden="true">
                    {session.user.email}
                  </span>
                </div>
              </div>
